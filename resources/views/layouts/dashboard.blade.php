                    ...
                    <ul class="nav d-flex flex-column bg-dark">
                        ...
                        <li class="nav-item px-1">
                            <a class="nav-link" href="{{route('host.apartments.index')}}">
                                ...
                                <span class="d-md-inline-block d-sm-none">My apartments</span>
                            </a>
                        </li>
                        <li class="nav-item px-1">
                            <a class="nav-link" href="{{route('host.apartments.create')}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                                <span class="d-md-inline-block d-sm-none">New apartment</span>
                            </a>
                        </li>
                        <li class="nav-item px-1">
                            ...
                            <a class="nav-link" href="{{route('host.messages')}}">
                                ...
                                <span class="d-md-inline-block d-sm-none">Messages</span>
                            </a>
                        </li>
                    </ul>
